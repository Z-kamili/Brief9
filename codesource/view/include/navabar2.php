            ...
            <ul>
                ...
                <li class="search">
                    <form action="/action_page.php">
                        ...
                        <button type="submit"><img src=" codesource/view/icons/Icon-search.png" alt=""></button>
                    </form> 
                </li>
                ...
                <li><a href="codesource/view/html/Login.php">
                ...
                <li></li>
                <li><a href="codesource/view/html/inscription.php">
                        <div class="deconnexionIcon"></div>
